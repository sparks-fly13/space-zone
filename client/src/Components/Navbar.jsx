    ...
    <Box>
      <Flex bg={useColorModeValue('white', 'gray.800')} color={useColorModeValue('gray.600', 'white')} minH={'60px'} py={{ base: 2 }} px={{ base: 4 }} borderBottom={1} borderStyle={'solid'} borderColor={useColorModeValue('gray.200', 'gray.900')} align={'center'}>
        ...
        <Stack flex={{ base: 1, md: 0 }} justify={'flex-end'} direction={'row'} spacing={6}>
          ...
          <Button as={ReactRouterLink} display={{ base: 'none', md: 'inline-flex' }} fontSize={'sm'} fontWeight={600} color={'white'} bg={'blue.400'} to='/signup' _hover={{ bg: 'blue.300'}}>
            Sign Up
          </Button>
          </>
          ) : (
            ...
            {(user.userImage === 'img' ? (
                <Link as={ReactRouterLink} to='/profile'>
                    <Image right='3rem' top='1rem' position='absolute' src={noPfp} alt="profile" width='30px' borderRadius='3xl' />
                </Link>
                    ) : (
                        <Link as={ReactRouterLink} to='/profile'>
                            <Image right='3rem' top='1rem' position='absolute' src={user.userImage} alt="profile" width='30px' borderRadius='3xl' />
                        </Link>
                ))}
            </>
          )
